...
class ObjectHandle:
   def __init__(self, clientID, robotname):
      ...
      erro, self.cor_esquerda_lateral  = sim.simxGetObjectHandle(self.clientID, 'Sensor_cor_lateral_direita1', sim.simx_opmode_blocking)
      erro, self.cor_direita_lateral = sim.simxGetObjectHandle(self.clientID, 'Sensor_cor_lateral_direita', sim.simx_opmode_blocking)
      erro, self.cor_esquerda_lateral1  = sim.simxGetObjectHandle(self.clientID, 'Sensor_cor_lateral_esquerda1', sim.simx_opmode_blocking)
      erro, self.cor_direita_lateral1 = sim.simxGetObjectHandle(self.clientID, 'Sensor_cor_lateral_direita1', sim.simx_opmode_blocking)
